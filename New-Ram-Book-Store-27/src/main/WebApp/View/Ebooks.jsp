...
<head>
    ...
    <title>Ram Book Store - Electronic Books</title>
...
<body>
    ...
    <header class="header-section text-center">
        <div class="container">
            <h1 class="display-4">Electronic Books</h1>
            ...
            <c:forEach var="ebook" items="${Ebooks}">
                <div class="col-md-4">
                    <div class="card mb-4 shadow-sm">
                        <img src="${ebook.image}" class="card-img-top" alt="Book 1">
                        <div class="card-body">
                            <h5 class="card-title">${ebook.bookname}</h5>
                            <p class="card-text">${ebook.description}</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="add-to-cart/${ebook.bookname}" class="btn btn-sm btn-primary">Cart</a>
                                <span class="text-muted">$${ebook.price}</span>
                            </div>
                        </div>
                    </div>
                </div>
